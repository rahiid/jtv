...
.auth-login-side-wrapper{
    width: 100%;
    height: 100%;
    background-image: url({{asset('images/login_logo.png')}});
}
...
<a href="#" class="noble-ui-logo logo-light d-block mb-2">JUPITER<span> DIAGNOSTIC</span></a>
...
<a href="register.html" class="d-block mt-3 text-muted">NOT REGISTERED YET? REGISTER NOW</a>
